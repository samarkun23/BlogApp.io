...
const Blogs = () => {
    return (
        <div>
            ...
            <p className='text-lg leading-6 max-w-2xl mx-auto'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quos ratione doloribus, enim animi commodi illum ipsam impedit quas blanditiis laborum, vitae perferendis ipsum? Ratione reprehenderit magnam officiis! Magni, dicta saepe.
